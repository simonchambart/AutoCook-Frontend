...
function Soldout4() {
  ...
  return (
    <div className="container mt-5">
      <h1 className="mb-4 text-center">Privé chef</h1>
        ...
        <div className="col-md-8">
          ...
          <div className="text-center mt-3">
              <div className="d-flex w-100 justify-content-center mb-2">
                ...
                <Link className="nav-link" to="/register" onClick={() => handleClick('RegistreerKnop Vanuit Privé-Chef-Scherm')}>Registreer</Link>
                </button>
              </div>
          </div>
        </div>
